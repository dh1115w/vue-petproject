        ...
        <div class="calendar-right-zone">
              ...
              >
                ...
                <div class="event-text-main">
                  <div class="event-title-row">
                    ...
                    <!-- 緊急與完成狀態小圖示 -->
                    <span v-if="event.urgent" class="status-icon text-danger"
                      >⚠️</span
                    >
                    <span v-if="event.done" class="status-icon text-success"
                      >✅</span
                    >
                  </div>
                  <div class="event-meta-info">
                    🕒 {{ event.time }}
                    <span v-if="event.clinic">· {{ event.clinic }}</span>
                  </div>
                </div>
          ...
          >
            ...
            <div class="line-card-header">
              <div
                class="line-icon-box"
                :class="{ 'line-active-icon': lineConnected }"
              >
              ...
              <div class="line-status-text">
                ...
                <div
                  class="line-desc"
                  :class="{ 'text-active': lineConnected }"
                >
              ...
              <div
                ...
                :class="{ 'dot-active': lineConnected }"
              ></div>
            </div>
              ...
              >
                ...
                <div
                  ...
                  :style="{
                    backgroundColor: event.urgent
                      ? '#df4733'
                      : getEventConfig(event.type).color,
                  }"
                >
                  ...
                  <span class="mini-box-month"
                    >{{ parseInt(event.date.split("-")[1]) }}月</span
                  >
                </div>
                ...
                <div class="upcoming-text-main">
                  <div class="upcoming-title-row">
                    ...
                    <span v-if="event.urgent" class="urgent-alert-icon"
                      >⚠️</span
                    >
                  </div>
                ...
                <span
                  ...
                  :style="{
                    backgroundColor: getEventConfig(event.type).bg,
...
// 🌟 自動獲取當前的真實年、月 (不再寫死 2026 或 3)
const currentYear = ref(today.getFullYear());
const currentMonth = ref(today.getMonth());

// 🌟 全自動生成今天日期的「YYYY-MM-DD」字串格式，作為預設選中值
// 例如今天 6 月 12 日，會自動生成 "2026-06-12"
const yearStr = today.getFullYear();
const monthStr = String(today.getMonth() + 1).padStart(2, "0"); // 補零
const dateStr = String(today.getDate()).padStart(2, "0"); // 補零
